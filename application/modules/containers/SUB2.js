 ...
 * Copyright 2018 FAPS.
 *
 * File: application/modules/southbounds/SUB2.js
 * Project: SP 142
 * Author:
 *  - Jupiter Bakakeu
 *
...
var SUB2 = function(settings) {
    if (!(this instanceof SUB2))
        return new SUB2(settings);
    ...
    this.compute = function(input_datas, output_datas) {
        //this.log("SUB2: a = " + input_datas["a"] + "; b = " + input_datas["b"]);
