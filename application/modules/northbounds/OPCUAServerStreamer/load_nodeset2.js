...
var getCurrentClock = require("lib/misc/date_time").getCurrentClock;
...
function generate_address_space(addressSpace, xmlFiles, callback) {
    ...
    var state_Variant =     {
        parser: {
            ...
            "ListOfBoolean": ListOf("Boolean",function (text) {
            ...
            "ListOfSByte": ListOf("SByte",function (text) {
                return  text;
            }),
            "Byte": {
                init: function () {
                ...
                finish: function () {
                    this.parent.parent.obj.value = {
                        ...
                        value: Buffer.from(this.text,"base64")[0]
                    }
                }
            },
            "ListOfByte": ListOf("Byte",function (text) {
                return  Buffer.from(text,"base64")[0];
            }),
            "Int16": {
                init: function () {
                    this.value = 0;
            ...
            "ListOfString":  ListOf("String", function(txt){
                return txt
            }),
            "DateTime": {
                init: function () {
            ...
            "ListOfDateTime":  ListOf("DateTime", function(txt){
            ...
            "ListOfByteString":  ListOf("ByteString", function(txt){
                var byteString = Buffer.from(txt,"base64");
                return byteString
            }),
            "LocalizedText": {
                init: function () {
