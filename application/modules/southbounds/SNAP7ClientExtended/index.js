 ...
 * --------------------------------------------------------------------
 * ###################### Description #####################################
 * SNAP7ClientExtended -- Below is a configuration example
 	example_config: {
		id: "SNAP7ClientExtended1", 		// Unique ID of the module in the global configuration
		name: "SNAP7ClientExtended1", 	    // Name of the module instance.
		type: "SNAP7ClientExtended", 	    // Type of the module, should always be "SNAP7ClientExtended" in order to use this module
		modulesetting: {
